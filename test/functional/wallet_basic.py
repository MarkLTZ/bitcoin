...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 LTZ from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 ltz in block rewards plus fees, but
        ...
        # Send 10 LTZ with subtract fee from amount
        ...
        # Sendmany 10 LTZ with subtract fee from amount
