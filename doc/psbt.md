...
Since LitecoinZ Core 0.17, an RPC interface exists for Partially Signed LitecoinZ
...
Later, when *V* LTZ has been received on *Amulti*, and Bob and Carol want to
