...
* Update translations (ping wumpus on IRC) see [translation_process.md](https://github.com/litecoinz-core/litecoinz/blob/master/doc/translation_process.md#synchronising-translations).
...
- Announce the release:
  ...
  - LitecoinZ Core announcements list https://bitcoincore.org/en/list/announcements/join/
