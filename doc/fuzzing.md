# Fuzzing LitecoinZ Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing LitecoinZ Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/litecoinz-core/litecoinz/blob/master/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/litecoinz-core/litecoinz/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/litecoinz-core/litecoinz/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/litecoinz-core/litecoinz/tree/master/src/test/fuzz).
...
Every single pull request submitted against the LitecoinZ Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make LitecoinZ Core more robust.
...
with certain assembly code from LitecoinZ Core's code. See [developer notes on sanitizers](https://github.com/litecoinz-core/litecoinz/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing LitecoinZ Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing LitecoinZ Core using [`afl-fuzz`](https://github.com/google/afl):
