 ...
 *  A CTxDestination is the internal data type encoded in a litecoinz address
 */
...
/**
 * Generate a LitecoinZ scriptPubKey for the given CTxDestination. Returns a P2PKH
