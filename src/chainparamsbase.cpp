...
void SetupChainParamsBaseOptions()
{
    ...
    gArgs.AddArg("-saplingheight=<n>", "Set the activation height of sapling. -1 to disable. (regtest-only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
